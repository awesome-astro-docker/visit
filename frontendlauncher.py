...
print >> sys.stderr, 'frontendlauncher:', frontendlauncherpy
...
if version[0] <= 1 or (version[0] == 2 and version[1] < 6):
    ...
    print >> sys.stderr, 'internallauncher', launcher
    ...
    if os.path.exists(customlauncher):
        print >> sys.stderr, 'customlauncher', customlauncher
    ...
    print >> sys.stderr, 'internallauncher', launcher, visitdir, progname, ver, visitpluginver, visitargs
